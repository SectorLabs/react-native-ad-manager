...
public class RNAdManagerBannerViewManager extends ViewGroupManager<BannerAdView> {
    ...
    public static final String PROP_SLOT_INDEX = "slotIndex";
    ...
    @ReactProp(name = PROP_SLOT_INDEX)
    public void setSlotIndex(final BannerAdView view, final String slotIndex) {
        view.setSlotIndex(slotIndex);
    }
